...
<body>
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <tr>
                <th style='width:120px'>ชื่อ-ชื่อคำสั่ง</th>
                <td><?php echo $row->doc_title;?></td>
            </tr>
            <tr>
                <th style='width:120px'>วันเริ่มต้นคำสั่ง</th>
                <td><?php echo $row->doc_start_date  ;?></td>
            </tr>
            <tr>
                <th style='width:120px'>วันสิ้นสุด</th>
            ...
            <tr>
                <th style='width:120px'>ชื่อไฟล์เอกสาร</th>
        ...
        <form action="delete_Appoint.php" method="post">
