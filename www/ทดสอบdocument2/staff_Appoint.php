    ...
    <div class="container">
        ...
        if ($result->num_rows == 0) {
            ...
            while($row = $result->fetch_object()){ 
                ...
                $table.= "<a href='edit_Staff.php?id=$row->sfid'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>";
                $table.= " | ";
                $table.= "<a href='delete_Staff.php?id=$row->sfid'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
                $table.= "</td>";
                $table.= "</tr>";
            }
