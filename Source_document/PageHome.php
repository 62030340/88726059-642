...
<body>
    <div class="container">
            <table > 
                ...
                <td class="tl2">
                <h3> <a href='index.php'>STATUS</a></h3> 
                </td>
                <td class="tl2">
                <h1>  &nbsp;  |  &nbsp; </h1> 
                ...
                <td class="tl2">
                <h3> <p><a href="index.php?logout='1'" style="color: red;">Logout</a></p></h3> 
                </td>
            </table>
        ...
        if ($result->num_rows == 0) {
            ...
            while($row = $result->fetch_object()){ 
                ...
                // $table.= "<td>";
                // $table.= "<a href='edit_Appoint.php?id=$row->id'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
                // $table.= " | ";
