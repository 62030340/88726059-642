    ...
    <div class="container">
        ...
        if ($result->num_rows == 0) {
            ...
            while($row = $result->fetch_object()){ 
                ...
                $table.= "<td><a href='KeepUp/$row->doc_file_Temp_name'>$row->doc_file_name</a></td>";
                $table.= "<td>";
                $table.= "<a href='edit_Appoint.php?id=$row->id'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>";
                $table.= " | ";
                // $table.= "<a href='SHOWA4_copy.php?id=$row->id'><span class='glyphicon glyphicon-book' aria-hidden='true'></span></a>";
                $table.= "<a href='ADD_DSTAFF.php?id=$row->id'><span class='glyphicon glyphicon-user' aria-hidden='true'></span></a>";
                // $table.= " | ";
                $table.= "<a href='delete_Appoint.php?id=$row->id'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
                $table.= " | ";
                $table.= "<a href='Add_doc_Staff.php?id=$row->id'><span class='glyphicon glyphicon-book' aria-hidden='true'></span></a>";
                // $table.= "<td><a href='KeepUp/$row->doc_file_Temp_name'>$row->doc_file_name</a></td>";
                $table.= "</td>";
                $table.= "</tr>";
            } 
