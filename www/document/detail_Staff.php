...
<head>
    <title> ลายละเอียดการจัดการข้อมูล </title>
    <meta charset="utf-8">
...
<body>
    <div class="container">
        <h1> ลายละเอียดการจัดการข้อมูล <br>
             <a href='PageHome.php'><span class='glyphicon glyphicon-home'></span></a> 
                ...
                <!-- <a href='management.php'><span class='glyphicon glyphicon-tag'></span></a> -->
        </h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ค้นหาข้อมูล value="">
            <input type="submit">
        </form>
        ...
        if ($result->num_rows == 0) {
            ...
            $table = "<table class='table table-hover'>
                        <thead>
                            <tr>
                                <th scope='col'>#</th>
                                <th scope='col'>รหัสคำสั่งแต่งตั้ง</th>
            ...
            while($row = $result->fetch_object()){ 
                $table.= "<tr>";
                $table.= "<td >" . $i++ . "</td>";
                $table.= "<td>$row->doc_id  </td>";
                $table.= "<td>$row->stf_id </td>";
                $table.= "<td>";
                
                
                $table.= "<a href='edit_Detail.php?id=$row->doc_id'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
                $table.= " | ";
                $table.= "<a href='delete_Staff.php?id=$row->doc_id'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
                $table.= "</td>";
                $table.= "</tr>";
            }
